...
OUT = Path(r"D:\MIRA-Lab\analysis\baselines\ego_identity_v0")
OUT.mkdir(parents=True, exist_ok=True)
P = "Mira is Mira. Cinder is Cinder. Mira speaks for herself.\n"
PROMPTS = [
...
for name, prompt in PROMPTS:
    ...
    row = {"name": name, "prompt": prompt, "first_turn": first_turn, "full": r["generated_text"]}
    rows.append(row)
...
print("EGO_IDENTITY_PROBE_COMPLETE", flush=True)
