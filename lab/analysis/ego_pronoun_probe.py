...
OUT = Path(r"D:\MIRA-Lab\analysis\baselines\ego_pronoun_v0")
OUT.mkdir(parents=True, exist_ok=True)
P = (
    "Mira is Mira. Cinder is Cinder. "
    "When Mira says I, I means Mira and you means Cinder. "
    "When Cinder says I, I means Cinder and you means Mira.\n"
)
PROMPTS = [
...
for name, prompt in PROMPTS:
    r = sm.generate(tok, prompt, weights, max_new=48, temperature=0.0, top_p=0.9, use_bos=True)
...
print("EGO_PRONOUN_PROBE_COMPLETE", flush=True)
