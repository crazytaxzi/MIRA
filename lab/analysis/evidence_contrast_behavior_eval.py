...
CHILD_PATH = Path(r"D:\MIRA-Lab\derived\evidence-contrast-layer11-r4-v0\adapter.pt")
OUT = Path(r"D:\MIRA-Lab\repo\Mira\lab\analysis\eval\evidence_contrast_behavior_v0.json")
