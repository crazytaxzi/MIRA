...
CHILD_PATH = Path(r"D:\MIRA-Lab\derived\evidence-contrast-layer20-r4-v0\adapter.pt")
OUT = Path(r"D:\MIRA-Lab\repo\Mira\lab\analysis\eval\evidence_contrast_behavior_l20.json")
