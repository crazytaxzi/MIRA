...
TRAIN_PATH = Path(r"D:\MIRA-Lab\training\projection_decoder_train.jsonl")
EVAL_PATH = Path(r"D:\MIRA-Lab\training\projection_decoder_eval.jsonl")
PARENT_PATH = Path(r"D:\MIRA-Lab\derived\ego-layer11-r8-lr5e5-200\adapter.pt")
OUT = Path(os.environ.get("MIRA_PROJ_OUT", r"D:\MIRA-Lab\derived\projection-decoder-layer11-r4-v0"))
STEPS = int(os.environ.get("MIRA_PROJ_STEPS", "180"))
LR = float(os.environ.get("MIRA_PROJ_LR", "0.00001"))
RANK = 4
ALPHA = 8.0
SCALE = ALPHA / RANK
ADAPT_LAYER = 11
...
def main():
    ...
    meta = {
        ...
        "elapsed_seconds": elapsed, "seed": 9127,
    }
    (OUT / "meta.json").write_text(json.dumps(meta, indent=2), encoding="utf-8")
    print(json.dumps(meta, indent=2), flush=True)
    print("PROJECTION_DECODER_LORA_TRAIN_COMPLETE", flush=True)
